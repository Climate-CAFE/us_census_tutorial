...
+ [What Variables are Available in a Dataset/Table?](#item-seven)
+ [How do I find the geographical coverage of a dataset/table?](#item-eight)
+ [How do you extract the data?](#item-nine)
+ [How can I interact with census data to explore specific variables?](.#item-ten)
+ [Where can I connect with experienced professionals to discuss census data?](#item-eleven)
